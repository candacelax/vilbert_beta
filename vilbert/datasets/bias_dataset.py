...
class BiasLoader(object):
    ...
    def __init__(
        ...
        preprocess_function = BertPreprocessBatch(
            ...
            36,
            self.num_dataset,
            ImageFeaturesH5Reader(image_features_fp),
            encoding="utf-8",
    ...
    def __iter__(self):
        for batch in self.ds.get_data():
            input_ids, input_mask, segment_ids, lm_label_ids, image_feat, \
                image_loc, image_label, image_mask, image_id = batch
            ...
            batch = (input_ids, input_mask, segment_ids, lm_label_ids, image_feat, \
                     image_loc, image_label, image_mask, image_id)
...
class BertPreprocessBatch(object):
    ...
    def __call__(self, data):
        ...
        try: # TODO cleaner
            image_feature, num_boxes, image_location, image_location_ori =\
                                    self.image_feature_reader[str(image_id)]
        except:
            image_fp = self.imageid2filepath[image_id]
            image_feature, num_boxes, image_location, image_location_ori =\
